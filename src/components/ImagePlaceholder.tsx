...
export function ImagePlaceholder({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-2xl ring-1 ring-white/40 shadow-lg shadow-emerald-900/10 ${aspectClassName} ${className}`}
    >
      ...
      <div className="absolute right-4 top-4 h-16 w-16 rounded-2xl border border-white/30 bg-white/10 backdrop-blur-sm" />
