  ...
  return (
    <div className={`${contentShell} space-y-10 py-12 md:py-16`}>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        <article className="interactive-card rounded-3xl border border-white/60 bg-gradient-to-br from-slate-900 via-emerald-950 to-teal-900 p-8 text-white shadow-xl shadow-emerald-900/20">
